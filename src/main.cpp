...
uint256 hashGenesisBlock("0x9df545661116e502b464791de0f2d998d69731e8e3012840ec1665ba95c9c915");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Snarfcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Snarfcoin Signed Message:\n";
...
{
    // Snarfcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Snarfcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Snarfcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Snarfcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Snarfcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Snarfcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Snarfcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1e585ee9eeef9583a26bdad654e52ed36e30bc46418fbabc76ac5b1dfd9c6ac9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("73d6cf5d6ec3495a0d93883f5c200c7c99cfbab0b55aa8ad78d9a7b7f56cf8eb3c541e21f76fb56fa119875f3dc0a117b011dc2aad8ee9df1d1b145a77dd6c5ea5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1429284251;
        block.nBits    = 504365644;
        block.nNonce   = 1489769022;

        if (fTestNet)
        {
            block.nTime    = 1429284251;
            block.nNonce   = 921930687;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2fe08433ee4a7ef7e03a4a3bae331c71c3eddd38927dfbb6333b686de25d0f33"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Snarfcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SnarfcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SnarfcoinMiner : ProcessBlock, block not accepted");
    }
